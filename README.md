...
```
D:\a\test\test\test_data\hard.cpp:63:14: warning: initialization clause of OpenMP for loop is not in canonical form ('var = init' or 'T var = init') [-Wopenmp-loop-form]
        for (int i(0); i < size; ++i)
             ^~~~~~~~~
D:\a\test\test\test_data\hard.cpp:76:10: warning: initialization clause of OpenMP for loop is not in canonical form ('var = init' or 'T var = init') [-Wopenmp-loop-form]
    for (int i(0); i < COUNT_LIGHT; ++i) {
         ^~~~~~~~~
D:\a\test\test\test_data\hard.cpp:91:10: warning: initialization clause of OpenMP for loop is not in canonical form ('var = init' or 'T var = init') [-Wopenmp-loop-form]
...
OK [program completed with code 0]
    [STDERR]:  
    [STDOUT]: Time (2 thread(s)): 4.4335 ms
78 131 188
...
OK [program completed with code 0]
    [STDERR]:  
    [STDOUT]: Time (1 thread(s)): 2.7348 ms
78 131 188
